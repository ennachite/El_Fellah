...
<footer id="footer" class="footer_area bg-black relative z-10">
    <div class="shape absolute left-0 top-0 opacity-5 h-full overflow-hidden w-1/3">
        <img src="${pageContext.request.contextPath}/assets/img/footer-shape-left.png" alt="">
    </div>
    <div class="shape absolute right-0 top-0 opacity-5 h-full overflow-hidden w-1/3">
        <img src="${pageContext.request.contextPath}/assets/img/footer-shape-right.png" alt="">
    </div>
    <div class="container">
                ...
                <div class="w-full md:w-1/2 lg:w-5/12">
                    <div class="footer_about mt-12 mx-3">
                        <div class="footer_logo">
                            <a href="/home"><img src="${pageContext.request.contextPath}/assets/img/footer_logo.png" width="100px" height="100px" alt="Logo"></a>
                        </div>
